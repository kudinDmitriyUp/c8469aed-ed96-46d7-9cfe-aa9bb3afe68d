...
export const metadata: Metadata = {
  title: "Joule Ventures | Venture Capital for Bold Founders",
  description: "Joule Ventures backs bold founders building the future from Atlanta and beyond. Investment in early-stage startups with focus on founders from US and Israel.",
  keywords: "venture capital, startup funding, angel investing, tech investment, founder support, Atlanta VC, Israeli founders",
  ...
  openGraph: {
    ...
    title: "Joule Ventures | Investing in Tomorrow's Innovators",
    description: "Venture capital firm supporting bold founders from Atlanta and beyond",
